...
import _ldap
from _ldap import *  # noqa: F403 # type: ignore
...
class LDAPLock:
    ...
    def acquire(self):
        if __debug__:
            ...
            if _trace_level >= self._min_trace_level:
                _trace_file.write(
                    f"***{self.__class__.__name__}.acquire() {self!r} {self._desc}\n"
                )
    ...
    def release(self):
        if __debug__:
            ...
            if _trace_level >= self._min_trace_level:
                _trace_file.write(
                    f"***{self.__class__.__name__}.release() {self!r} {self._desc}\n"
                )
...
from ldap.dn import dn2str, explode_dn, explode_rdn, str2dn  # noqa: E402
from ldap.functions import (  # noqa: E402
    escape_str,
    get_option,
    initialize,
    set_option,
...
from ldap.ldapobject import NO_UNIQUE_ENTRY, LDAPBytesWarning  # noqa: E402
...
OPT_DIAGNOSTIC_MESSAGE = OPT_ERROR_STRING  # noqa: F405
