...
class TestDN(unittest.TestCase):
    ...
    def test_escape_dn_chars(self):
        ...
        self.assertEqual(ldap.dn.escape_dn_chars("foobar "), r"foobar\ ")
        self.assertEqual(
            ldap.dn.escape_dn_chars('f+o>o,b<a;r="\00"'), r"f\+o\>o\,b\<a\;r\=\"\00\""
        )
    ...
    def test_str2dn(self):
        ...
        self.assertEqual(
            ldap.dn.str2dn(
                "/dc=com/dc=example/ou=Testing/uid=test42", flags=ldap.DN_FORMAT_DCE
            ),
            [
                [("uid", "test42", 1)],
                [("ou", "Testing", 1)],
    ...
    def test_explode_rdn(self):
        ...
        self.assertEqual(
            ldap.dn.explode_rdn("uid=test42", notypes=False, flags=0), ["uid=test42"]
        )
        self.assertEqual(
            ldap.dn.explode_rdn("uid=test42", notypes=0, flags=0), ["uid=test42"]
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ldap.dn.explode_rdn(r"uid=test\+ 42", flags=0), [r"uid=test\+ 42"]
        )
    ...
    def test_normalize(self):
        ...
        self.assertEqual(
            ldap.dn.normalize(
                "cn=#C3A4C3B6C3BCC384C396C39CC39F,dc=example,dc=com", flags=0
            ),
            "cn=äöüÄÖÜß,dc=example,dc=com",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ldap.dn.normalize(
                "cn=äöüÄÖÜß,dc=example,dc=com", flags=ldap.DN_FORMAT_LDAPV3
            ),
            r"cn=\C3\A4\C3\B6\C3\BC\C3\84\C3\96\C3\9C\C3\9F,dc=example,dc=com",
        )
        self.assertEqual(
