...
PRC_ENC = (
    b"db\x04)uid=Administrator,cn=users,l=school,l=dev0503\x04\tentryUUID1&"
    b"\x04$5d96cc2c-8e13-103a-8ca5-2f74868e0e44"
)
...
class TestLibldapControls(unittest.TestCase):
    ...
    def test_readentry_decode(self):
        ...
        self.assertEqual(
            pr.entry, {"entryUUID": [b"5d96cc2c-8e13-103a-8ca5-2f74868e0e44"]}
        )
