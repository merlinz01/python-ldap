...
import ldap
import ldapurl
from ldap.controls.psearch import (
    CHANGE_TYPES_STR,
...
while True:
    try:
        ...
        for _dn, _entry, srv_ctrls in res_data:
            ecn_ctrls = [
                c
                for c in srv_ctrls
            ...
            if ecn_ctrls:
                ...
                print(
                    f"changeType: {change_type_desc} ({changeType}), "
                    f"changeNumber: {changeNumber}, previousDN: {previousDN!r}"
                )
